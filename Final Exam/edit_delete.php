...
if (isset($_POST['update'])) {
    ...
    $sql= mysqli_query($dbname, "UPDATE applicant SET fname='$Name', email='$Email', gpa='$GPA', companypreference='$CompanyPreference' WHERE  id=$id");
...
if (isset($_GET['del'])) {
    $id = $_GET['del'];
    mysqli_query($dbname, "DELETE FROM applicant WHERE id=$id");
