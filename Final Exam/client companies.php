        ...
        <div class="col-12 mt-3">
            <div class="card">
                <div class="card-horizontal">
                    ...
                    Majors: Business Administration, Computer Science, Management Information Systems,Computer Engineering <br>
                    </p>
                    </div>
                </div>
                <div class="card-footer">
                    <small class="text-muted">Accounting Firm</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="card">
                ...
                <div class="card-footer">
                    <small class="text-muted">Banking Solutions</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="card">
                ...
                <div class="card-footer">
                    <small class="text-muted">Food Processing</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="card">
                ...
                <div class="card-footer">
                    <small class="text-muted">Tech and IT</small>
                </div>
            </div>
        </div>
    </div>
